...
class CategoriaController {
  ...
  async GetById(req, res) {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Error al obtener la categoría", error });
    }
  }
  ...
  async Save(req, res) {
    try {
      ...
      if (!nombre || nombre.trim() === "") {
        return res
          .status(400)
          .json({ message: "Nombre de la categoría es requerido" });
      }
      ...
      return res
        .status(500)
        .json({
          message: "Error al crear la categoría y subcategorías",
          error,
        });
    }
  }
  ...
  async SavesAll(req, res) {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Error al crear las categorías", error });
    }
  }
  ...
  async SubCategoriaBelongs(req, res) {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Error al obtener las subcategorías", error });
    }
  }
  ...
  async Update(req, res) {
    try {
      ...
      if (subcategorias && subcategorias.length > 0) {
        ...
        categoria.subcategorias = subcategoriasActualizadas.filter(
      ...
      return res
        .status(500)
        .json({
          message: "Error al actualizar la categoría y subcategorías",
          error,
        });
    }
  }
